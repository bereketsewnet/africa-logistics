...
- Name: auth.spec.ts >> Register page >> shows the register form
- Location: tests/auth.spec.ts:77:3
...
Locator: getByRole('button', { name: /driver/i })
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /driver/i })
...
- generic [ref=e5]:
  - generic [ref=e6]:
    ...
    - paragraph [ref=e8]: Enter phone number
  - generic [ref=e13]:
    - generic [ref=e14]:
      - generic [ref=e15]: Phone number
      - generic [ref=e17]:
        - generic [ref=e18] [cursor=pointer]:
          - combobox "Phone number country" [ref=e19]:
            ...
            - option "Zimbabwe"
          - img [ref=e21]
        - textbox "965 500 639" [ref=e23]: "+251"
    - button "Send OTP via SMS" [ref=e24] [cursor=pointer]:
      - generic [ref=e25]:
        - text: Send OTP via SMS
        - img [ref=e26]
    - generic [ref=e28]: or
    - button "Register with Telegram" [ref=e29] [cursor=pointer]:
      - img [ref=e30]
...
> 79  |     await expect(page.getByRole('button', { name: /driver/i })).toBeVisible()
  ...
  146 |   })
  147 | 
  148 |   test('unauthenticated user is redirected from /admin to /login', async ({ page }) => {
  149 |     await page.goto('/admin')
  150 |     await expect(page).toHaveURL(/\/login/, { timeout: 8_000 })
  151 |   })
  152 | })
  153 | 
```