...
- Name: auth.spec.ts >> Login page >> has link to register page
- Location: tests/auth.spec.ts:57:3
...
Call log:
  - waiting for getByRole('link', { name: /create account|register|sign up/i })
